...
/*
 * DeparseRowExprForColumnDefault returns string representation of given
 * rawExpr based on given column type information.
 */
static char *
DeparseRowExprForColumnDefault(Oid relationId, Oid columnTypeId, int32 columnTypeMod,
	...
	foreach(constraintCell, columnDefinition->constraints)
	{
		...
		else if (constraint->contype == CONSTR_DEFAULT)
		{
			...
			appendStringInfo(buf, " DEFAULT %s",
							 DeparseRowExprForColumnDefault(relationId, typeOid, typmod,
